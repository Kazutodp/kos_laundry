    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div id="laundry-list" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-lg">
            @foreach ($mitra as $m)
                ...
                @endphp
                <!-- Shop Card -->
                <div class="group bg-surface rounded-xl overflow-hidden shadow-sm border border-outline-variant hover:shadow-md transition-all laundry-card" data-lat="{{ $m->latitude }}" data-lng="{{ $m->longitude }}">
                    ...
                    <div class="flex gap-lg shrink-0">
                        ...
                        <div class="w-[300px] md:w-[380px] shrink-0 bg-surface-container-lowest p-lg rounded-2xl border border-outline-variant/60 shadow-sm flex flex-col justify-between space-y-lg hover:-translate-y-1 hover:shadow-md transition-all duration-200 whitespace-normal">
                            ...
                            <div class="flex items-center gap-md border-t border-outline-variant/30 pt-md">
                                <img src="{{ asset('uploads/student_1.png') }}" alt="Aulia Putri" class="w-10 h-10 rounded-full object-cover shadow-sm">
                                <div>
                        ...
                        <div class="w-[300px] md:w-[380px] shrink-0 bg-surface-container-lowest p-lg rounded-2xl border border-outline-variant/60 shadow-sm flex flex-col justify-between space-y-lg hover:-translate-y-1 hover:shadow-md transition-all duration-200 whitespace-normal">
                            ...
                            <div class="flex items-center gap-md border-t border-outline-variant/30 pt-md">
                                <img src="{{ asset('uploads/student_3.png') }}" alt="Dewi Lestari" class="w-10 h-10 rounded-full object-cover shadow-sm">
                                <div>
                        ...
                        <div class="w-[300px] md:w-[380px] shrink-0 bg-surface-container-lowest p-lg rounded-2xl border border-outline-variant/60 shadow-sm flex flex-col justify-between space-y-lg hover:-translate-y-1 hover:shadow-md transition-all duration-200 whitespace-normal">
                            ...
                            <div class="flex items-center gap-md border-t border-outline-variant/30 pt-md">
                                <img src="{{ asset('uploads/student_5.png') }}" alt="Fikri Ramadhan" class="w-10 h-10 rounded-full object-cover shadow-sm">
                                <div>
...
<footer class="w-full bg-slate-950 text-slate-400 border-t border-slate-900 mt-xl">
    <div class="max-w-7xl mx-auto px-gutter py-xl grid grid-cols-1 md:grid-cols-4 gap-xl">
        ...
        <div class="space-y-md">
            ...
            <ul class="space-y-sm text-body-md">
                <li>
                    <a href="#" class="hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block">Laundry Kiloan</a>
                </li>
                <li>
                    <a href="#" class="hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block">Laundry Satuan</a>
                </li>
                <li>
                    <a href="#" class="hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block">Cuci Sepatu Premium</a>
                </li>
                <li>
                    <a href="#" class="hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block">Express Delivery</a>
                </li>
            </ul>
        </div>
...
<script>
    ...
    const staticSuggestions = [
        // Services
        { name: "Laundry Baju (Kiloan)", type: "layanan", url: "{{ asset('layanan/layanan.php?service=baju') }}", detail: "Kiloan, setrika uap, cuci kilat" },
        { name: "Cuci Sepatu & Tas", type: "layanan", url: "{{ asset('layanan/layanan.php?service=sepatu') }}", detail: "Deep cleaning, premium shoe care" },
        { name: "Satuan & Dry Cleaning", type: "layanan", url: "{{ asset('layanan/layanan.php?service=satuan') }}", detail: "Bed cover, jas, kebaya, jaket" },
        // Locations
        { name: "Sekarbela / Kekalik", type: "lokasi", url: "{{ asset('layanan/layanan.php?location=sekarbela') }}", detail: "Area Sekarbela & Kekalik" },
        { name: "Ampenan", type: "lokasi", url: "{{ asset('layanan/layanan.php?location=ampenan') }}", detail: "Area Ampenan & sekitarnya" },
        { name: "Cilinaya", type: "lokasi", url: "{{ asset('layanan/layanan.php?location=cilinaya') }}", detail: "Area Cilinaya & sekitarnya" },
        { name: "Pagutan", type: "lokasi", url: "{{ asset('layanan/layanan.php?location=pagutan') }}", detail: "Area Pagutan & sekitarnya" },
        { name: "Mataram (Pusat)", type: "lokasi", url: "{{ asset('layanan/layanan.php?location=mataram') }}", detail: "Area Mataram Pusat" }
    ];
