<?php
$nama_mitra = 'aQualis Laundry & Green Dry Clean - Mataram';
$jam_operasional_html = '<div class="w-full space-y-1">
    <div class="flex py-[2px] text-sm">
        <span class="text-on-surface-variant w-28 shrink-0 text-left">Senin - Minggu 08</span>
        <span class="font-bold text-on-surface flex-1 text-left">00 - 22:00</span>
    </div>
</div>';

// Custom pricing overrides matching the database base price
$custom_harga_lipat_reguler = 12000;
