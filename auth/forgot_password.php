...
<a class="inline-flex items-center gap-xs font-label-md text-label-md text-primary hover:text-primary-container transition-colors group" href="login.html">
        ...
        function handleFormSubmit(event) {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    btnText.textContent = 'Kirim Instruksi';
