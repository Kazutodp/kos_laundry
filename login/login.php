    ...
    <section class="flex-grow md:w-1/2 lg:w-2/5 flex flex-col justify-center px-container-margin py-xl bg-surface-container-lowest relative">
        ...
        <div class="max-w-md w-full mx-auto">
            ...
            <form class="space-y-md" onsubmit="event.preventDefault();">
                ...
                <div class="space-y-xs hidden" id="username-field">
                    ...
                    <div class="relative">
                        ...
                        <input class="w-full pl-[48px] pr-md py-sm bg-surface-container-low border border-outline-variant rounded-lg focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all font-body-md text-on-surface" id="username" placeholder="username_anda" type="text"/>
                    </div>
                </div>
                <!-- Email -->
                <div class="space-y-xs">
                    ...
                    <div class="relative">
                        ...
                        <input class="w-full pl-[48px] pr-md py-sm bg-surface-container-low border border-outline-variant rounded-lg focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all font-body-md text-on-surface" id="email" placeholder="contoh@email.com" required="" type="email"/>
                    </div>
                </div>
                <!-- Password -->
                <div class="space-y-xs">
                    ...
                    <div class="relative">
                        ...
                        <input class="w-full pl-[48px] pr-12 py-sm bg-surface-container-low border border-outline-variant rounded-lg focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all font-body-md text-on-surface" id="password" placeholder="••••••••" required="" type="password"/>
                ...
                <!-- Password Ulang (Hidden by default) -->
                <div class="space-y-xs hidden" id="confirm-password-field">
                    ...
                    <div class="relative">
                        ...
                        <input class="w-full pl-[48px] pr-12 py-sm bg-surface-container-low border border-outline-variant rounded-lg focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all font-body-md text-on-surface" id="confirm-password" placeholder="••••••••" type="password"/>
            ...
            <footer class="mt-xl text-center space-y-md">
                <p class="font-label-md text-label-md text-on-surface-variant" id="switch-mode-text-wrapper">
                    <span id="switch-mode-prefix">Belum punya akun? </span><a class="text-primary font-bold hover:underline" href="#" id="switch-mode-link">Daftar Sekarang</a>
                </p>
...
<script>
    ...
    const switchModePrefix = document.getElementById('switch-mode-prefix');
    const usernameField = document.getElementById('username-field');
    const confirmPasswordField = document.getElementById('confirm-password-field');
    const optionsContainer = document.getElementById('options-container');
    const submitBtnText = document.getElementById('submit-btn-text');
    const pageTitle = document.querySelector('h2.font-headline-lg');
    const pageSubtitle = document.querySelector('header.mb-lg p');
    ...
    if (switchModeLink) {
        switchModeLink.addEventListener('click', (e) => {
            ...
            if (isLoginMode) {
                ...
                pageSubtitle.textContent = "Silakan masuk untuk mengelola pesanan laundry Anda.";
                usernameField.classList.add('hidden');
                confirmPasswordField.classList.add('hidden');
                optionsContainer.classList.remove('hidden');
                submitBtnText.textContent = "Masuk Sekarang";
                switchModePrefix.textContent = "Belum punya akun? ";
                switchModeLink.textContent = "Daftar Sekarang";
                
                // Remove required attribute from register fields
                usernameInput.removeAttribute('required');
                confirmPasswordInput.removeAttribute('required');
            } else {
                // Switch to Register Mode
                pageTitle.textContent = "Daftar Akun";
                pageSubtitle.textContent = "Silakan isi data untuk membuat akun baru.";
                usernameField.classList.remove('hidden');
                confirmPasswordField.classList.remove('hidden');
                optionsContainer.classList.add('hidden');
                submitBtnText.textContent = "Daftar Sekarang";
                switchModePrefix.textContent = "Sudah punya akun? ";
                switchModeLink.textContent = "Masuk Sekarang";
                
                // Add required attribute for validation in register mode
