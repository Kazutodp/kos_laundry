...
<head>
    ...
    <title>Wilayah Operasional | KosanLaundry Admin</title>
...
<body class="bg-surface text-on-surface min-h-screen flex overflow-hidden">
    ...
    <aside class="hidden lg:flex flex-col h-screen sticky top-0 p-md space-y-md bg-surface-container-low border-r border-outline-variant w-64 shrink-0">
        ...
        <div class="flex flex-col gap-xs py-md border-b border-outline-variant">
            ...
            <a class="flex items-center gap-sm px-md py-sm bg-primary-container text-on-primary-container rounded-lg font-bold translate-x-1 transition-transform" href="operational_area.php">
    ...
    <main class="flex-grow flex flex-col h-screen overflow-hidden">
        ...
        <div class="flex-grow overflow-y-auto custom-scrollbar p-lg">
            <div class="max-w-7xl mx-auto space-y-lg">
                ...
                <div>
                    ...
                    <p class="text-body-md text-on-surface-variant">Monitor cakupan geografis dan lokasi outlet fisik seluruh mitra KosanLaundry.</p>
                </div>
        ...
        <!-- Footer -->
        <footer class="w-full py-md px-lg bg-surface-container-highest flex justify-between items-center text-on-surface-variant mt-auto">
